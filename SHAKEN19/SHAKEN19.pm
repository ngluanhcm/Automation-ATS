...
our ($ses_core, $ses_glcas, $ses_logutil,$ses_calltrak, $ses_tapi, $ses_ats, $ses_cli1, $ses_cli, $gwc_id, $ofrt_config);
...
our %tc_line = ('TC0' => ['pbx','sip_1','gr303_1'],
                ...
                'tms1286689' => ['gr303_1','sip_2'],
                'tms1286690' => ['gr303_1','Sip_pbx'],
                'tms1286691' => ['sip_2','sip_1'],
                'tms1286692' => ['Sip_pbx','Sip_pbx2'],
                'tms1286693' => ['gr303_1','sip_2'],
