...
package QATEST::ADQ1131::ADQ1131;
...
our %tc_line = (
                'ADQ1131_001' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_002' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_003' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_004' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_005' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_006' => ['V52_1','V52_2','V52_3'],
				'ADQ1131_007' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_008' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_009' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_010' => ['V52_1','V52_2','V52_3','V52_4', 'V52_5'],
				'ADQ1131_011' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_012' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_013' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_014' => ['V52_1','V52_2','V52_3'],
                'ADQ1131_015' => ['V52_1','V52_2','V52_3','V52_4'],
				'ADQ1131_016' => ['V52_1','V52_2','V52_3'],
				'ADQ1131_017' => ['V52_1','V52_2','V52_3'],
				'ADQ1131_018' => ['V52_1','V52_2','V52_3'],
				'ADQ1131_019' => ['V52_1','V52_2','V52_3'],
				'ADQ1131_020' => ['V52_1','V52_2','V52_3'],
);
...
sub ADQ1131_checkResult {
    my ($tcid, $result) = (@_);
    my $subname = "ADQ1131_checkResult";
...
# + For LI TCs:  Please check account thong/thong then access core LI  by user/pass is: dnbdord ->123456.
...
sub ADQ1131_001 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_001");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_001";
    my $tcid = "ADQ1131_001";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;

    open(FH,'>',$execution_logs) or die $!;
    move($dir."/".$execution_logs,"/home/".$user_name."/ats_user/logs/ADQ1131");
...
################################## Cleanup  ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_001 ##################################");
    ...
    close(FH);
    &ADQ1131_cleanup();
    &ADQ1131_checkResult($tcid, $result);    
}

sub ADQ1131_002 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_002");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_002";
    my $tcid = "ADQ1131_002";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Check line status
	...
	$ses_core_li->execCmd("add XUYEN YES FTPV4 047 135 041 070 021 ibn $list_dn[0] +");
...
sub ADQ1131_003 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_003");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_003";
    my $tcid = "ADQ1131_003";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_004 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_004");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_004";
    my $tcid = "ADQ1131_004";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_005 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_005");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_005";
    my $tcid = "ADQ1131_005";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_006 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_006");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_006";
    my $tcid = "ADQ1131_006";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_007 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_007");
    
############ Variables Declaration ####################################################
    my $sub_name = "ADQ1131_007";
    my $tcid = "ADQ1131_007";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Check line status
    ...
    # unless(grep /SDN/, $ses_core->execCmd("qdn $list_dn[0]")) {
        # $logger->error(__PACKAGE__ . ".$sub_name: Cannot add SDN for line $list_dn[0] ");
        # print FH "STEP: Verify add SDN for line A $list_dn[0] - FAIL\n";
        # $result = 0;
        # goto CLEANUP;
    # } else {
        # print FH "STEP: Verify add SDN for line A $list_dn[0] - PASS\n";
    # }
...
# Call flow
   ...
   # B offhook and activate scps_acc 
    ...
    $dialed_num = $trunk_access_code . $dialed_num;
	 my $scs_num = 5 . $dialed_num . '#';
	 my $scs_num_1 = '*' . $scps_acc;
	 print FH "dials num is $scs_num \n";
	 
	 %input = (
                -line_port => $list_line[1],
                -dialed_number => $scs_num_1,
                -digit_on => 300,
                -digit_off => 300,
                -wait_for_event_time => $wait_for_event_time
                ); 
    ...
    unless($ses_glcas->sendDigitsWithDurationCAS(%input)) {
        $logger->error(__PACKAGE__ . ": Cannot dial $scs_num_1 successfully");
    }
	sleep (1); # Waiting after confirmation tone
	 %input = (
                -line_port => $list_line[1],
...
sub ADQ1131_008 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_008");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_008";
    my $tcid = "ADQ1131_008";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
	...
	############################## Trunk DB #####################################
    my $trunk_access_code = $db_trunk{'pri_1'}{-acc};
    my $trunk_region = $db_trunk{'pri_1'}{-region};
    my $trunk_clli = $db_trunk{'pri_1'}{-clli};
...
sub ADQ1131_009 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_009");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_009";
    my $tcid = "ADQ1131_009";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Check line status
	...
	$ses_core_li->execCmd("add XUYEN YES FTPV4 047 135 041 070 021 ibn $list_dn[3] +");
	unless(grep /Please confirm/, $ses_core_li->execCmd("10 151515 yes $lea_num yes RESTP px 515151 NONE no speech no YES yes 1")) {
...
sub ADQ1131_010 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_010");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_010";
    my $tcid = "ADQ1131_010";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Check line status
	...
	unless(grep /UNASSIGNED/, $ses_core->execCmd("qdn $list_dn[4]")) {
        ...
        print FH "STEP: Out line $list_dn[4] for SDN - FAIL\n";
        $result = 0;
        goto CLEANUP;
    } else {
        print FH "STEP: Out line $list_dn[4] for SDN - PASS\n";
		$un_line = $list_dn[4];
    }
	# A has SDN ($un_line)
    unless ($ses_core->callFeature(-featureName => "SDN $un_line 3 p \$", -dialNumber => $list_dn[0], -deleteFeature => 'No')) {
...
################################## Cleanup ##################################
	...
	# New line E for running the next TC
...
sub ADQ1131_011 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_011");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_011";
    my $tcid = "ADQ1131_011";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_012 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_012");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_012";
    my $tcid = "ADQ1131_012";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Call flow
 ...
 # Make call D to C via SST
    ...
    %input = (
                ...
                -digit_on => 300,
                -digit_off => 300,
                -detect => ['DELAY 5', 'RINGBACK', 'RINGING'],
                -ring_on => [0],
                -ring_off => [0],
                -on_off_hook => ['offB'],
                -send_receive => ['TESTTONE'],
...
sub ADQ1131_013 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_013");
    
########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_013";
    my $tcid = "ADQ1131_013";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
sub ADQ1131_014 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_014");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_014";
	my $tcid = "ADQ1131_014";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
################################## Cleanup ADQ1131_014 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_014 ##################################");
...
sub ADQ1131_015 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_015");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_015";
	my $tcid = "ADQ1131_015";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Add SCA to line A with C in list
	...
	unless (grep /SCA NOAMA ACT/, $ses_core->execCmd("qdn $list_dn[0]")) {
            $logger->error(__PACKAGE__ . " $tcid: Line $list_dn[0] didn't add SCA successfully");
            print FH "STEP: Verify line A ($list_dn[0]) has SCA feature - FAILED\n";
			$result = 0;
            goto CLEANUP;
          
    } else {
            print FH "STEP: Verify line A ($list_dn[0]) has SCA feature - PASSED\n";
        }
# Verify the table SLELIST contains C
	if (grep /UNKNOWN TABLE/, $ses_core->execCmd("table SLELIST")) {
		...
		#print FH "STEP: Login to table NCOS - PASSED\n";
...
################################## Cleanup ADQ1131_015 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_015 ##################################");
...
sub ADQ1131_016 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_016");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_016";
	my $tcid = "ADQ1131_016";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# A calls B, B answers and on-hook
    ($dialed_num) = ($list_dn[1] =~ /\d{3}(\d+)/);
    $dialed_num = $trunk_access_code . $dialed_num;
	print FH "The dialed number through PRI on TMA20: $dialed_num\n";
    %input = (
                -lineA => $list_line[0],
                -lineB => $list_line[1],
                #-dialed_number => $list_dn[1],
...
################################## Cleanup ADQ1131_016 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_016 ##################################");
...
sub ADQ1131_017 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_017");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_017";
	my $tcid = "ADQ1131_017";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Determine the size of table SITE
	...
	if ($count == 2048){
		$ses_core->execCmd("bottom");
		#$ses_core->execCmd("delete");
		unless (grep /Y TO CONTINUE/, $ses_core->execCmd("delete")){
			unless (grep /Y TO CONFIRM/, $ses_core->execCmd("Y")){
				unless (grep /TUPLE DELETED/, $ses_core->execCmd("Y")){
					$logger->error(__PACKAGE__ . " $tcid: Can't delete the last tuple");
					print FH "STEP: Delete the last tuple of table SITE - FAILED\n";
					$result = 0;
					goto CLEANUP;
				} else {
					print FH "STEP: Delete the last tuple of table SITE - PASSED\n";
				}
...
################################## Cleanup ADQ1131_017 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_017 ##################################");
...
sub ADQ1131_018 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_018");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_018";
	my $tcid = "ADQ1131_018";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
# Replace the tuple
	if ($add_tuple){
		if(grep /PHUC/, $ses_core->execCmd("pos PHUC 0")){
			if (/Y TO CONTINUE/, $ses_core->execCmd("rep PHUC 0 3 TEST \$")){
			...
			} elsif (/Y TO CONFIRM/, $ses_core->execCmd("rep PHUC 0 3 TEST \$")){
				if (/TUPLE REPLACED/, $ses_core->execCmd("y")){
						print FH "STEP: Replace the tuple - PASSED\n";
				} else{
						print FH "STEP: Replace the tuple - FAILED\n";
...
################################## Cleanup ADQ1131_018 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_018 ##################################");
...
sub ADQ1131_019 {
    $logger->debug(__PACKAGE__ . " Inside test case ADQ1131_019");

########################### Variables Declaration #############################
    my $sub_name = "ADQ1131_019";
	my $tcid = "ADQ1131_019";
    my $execution_logs = $tcid.'_ExecutionLogs_'.$datestamp.'.txt';
    my $result = 1;
...
################################# LOGIN #######################################
	...
	unless ($ses_ossgate = SonusQA::ATSHELPER::newFromAlias(-tms_alias => $TESTBED{"c20:1:ce0"}, -sessionLog => $tcid."_OSSGATESessionLog")) {
        $logger->error(__PACKAGE__ . " $tcid: Could not create C20 object for tms_alias => $TESTBED{'c20:1:ce0'}" );
        print FH "STEP: Login TMA20 for OSSGATE - FAILED\n";
        $result = 0;
        goto CLEANUP;
    } else {
        print FH "STEP: Login TMA20 for OSSGATE - PASSED\n";
    }
	unless ($ses_tapi = SonusQA::ATSHELPER::newFromAlias(-tms_alias => $TESTBED{"c20:1:ce0"}, -sessionLog => $tcid."_TapiTraceSessionLog")) {
        $logger->error(__PACKAGE__ . " $tcid: Could not create C20 object for tms_alias => $TESTBED{'c20:1:ce0'}" );
        print FH "STEP: Login TMA20 for tapi trace- FAILED\n";
...
################################## Cleanup ADQ1131_019 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_019 ##################################");
...
# Associate GW with GWC
	# Using GWC 11 (with hightest frame is 511) for TMA20, use gwc 30 (with hightest frame is 818) for TMA15
	my $str_1 = '<?xml version="1.0" encoding="UTF-8" ?>
<CommandList>
        <Command>
                    <Interface>cs2kCfgMgrIf</Interface>
...
################################## Cleanup ADQ1131_020 ##################################
    CLEANUP:
    $logger->debug(__PACKAGE__ . " $tcid: ################################ Cleanup ADQ1131_020 ##################################");
