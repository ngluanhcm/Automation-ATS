...
use QATEST::C20_EO::Luan::Automation_ATS::SHAKEN19_SV::SHAKEN19_SV; 
...
&QATEST::C20_EO::Luan::Automation_ATS::SHAKEN19_SV::SHAKEN19_SV::runTests;  ################  For running all tests #########################

#&QATEST::C20_EO::Luan::Automation_ATS::SHAKEN19_SV::SHAKEN19_SV::runTests("TC5");  ################  For running selective tests #########################
