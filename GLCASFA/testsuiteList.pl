...
use QATEST::C20_EO::Luan::GLCASFA::Luan; 
...
#&QATEST::C20_EO::Luan::GLCASFA::Luan::runTests;  ################  For running all tests #########################

&QATEST::C20_EO::Luan::GLCASFA::Luan::runTests("TC1");  ################  For running selective tests #########################
