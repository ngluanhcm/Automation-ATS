...
$TESTSUITE->{PATH} = '/home/ntthuyhuong/ats_user/logs/'.$TESTSUITE->{TESTED_RELEASE};   # CGE Log Path to Store Server logs and Core Files. 
...
#####################################
# , "ADQ729"
&QATEST::ADQ1126::ADQ1126::runTests;  ################  For running all tests #########################
# &QATEST::C20_EO::ADQ729::ADQ729::runTests("ADQ729_001");  ################  For running selective tests #########################
