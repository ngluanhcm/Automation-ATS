...
use QATEST::C20_EO::Luan::SHAKEN::SHAKEN; 
...
&QATEST::C20_EO::Luan::SHAKEN::SHAKEN::runTests;  ################  For running all tests #########################

#&QATEST::C20_EO::Luan::SHAKEN::SHAKEN::runTests("TC39","TC39",);  ################  For running selective tests #########################
#,"TC43","TC44","TC45"
1;
