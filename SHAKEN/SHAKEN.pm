...
#STRSHKN_ORIGID ADMINENTERED 16 char
    ...
    foreach ('cha','ADMINENTERED KINGOFKINGS12345','y') {
        unless ($ses_core->execCmd($_)) {
            $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
            last;
        }
...
#STRSHKN_ORIGID ADMINENTERED > 16 char
    ...
    foreach ('cha','ADMINENTERED high16char123123123','y') {
        unless ($ses_core->execCmd($_)) {
            $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
            last;
        }
...
# config table OFRT
    ...
    foreach ('cha','N','D',$db_trunk{'t15_g9_isup'}{-clli},'3','775','n','$','$','y') {
        unless ($ses_core->execCmd($_)) {
            $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
            last;
        }
...
################################## Cleanup 042 ##################################
    ...
    if ($ofrt_config) {
        ...
        foreach ('cha','N','D',$db_trunk{'t15_g9_isup'}{-clli},'3','$','n','$','$','y') {
            unless ($ses_core->execCmd($_)) {
                $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
                last;
            }
...
# config table OFRT
    ...
    foreach ('cha','N','D',$db_trunk{'t15_sst'}{-clli},'3',$db_trunk{'t15_g9_isup'}{-acc},'n','$','$','y') {
        unless ($ses_core->execCmd($_)) {
            $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
            last;
        }
...
################################## Cleanup 080 ##################################
    ...
    if ($ofrt_config) {
        ...
        foreach ('cha','N','D',$db_trunk{'t15_sst'}{-clli},'3','$','n','$','$','y') {
            unless ($ses_core->execCmd($_)) {
                $logger->error(__PACKAGE__ . " $tcid: cannot execute command '$_' ");
                last;
            }
